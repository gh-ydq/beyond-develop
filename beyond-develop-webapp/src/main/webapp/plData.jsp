...
<body>  
	...
	<div style="margin:20px 0;" align="left">
		<div class="easyui-panel" title="PL" style="width:800px">
			<div style="padding:10px 60px 20px 60px">
			    <form id="ff" method="post" action="">
			    	<table cellpadding="5">
			    		...
			    		<tr>
			    			<td>lac(位置区域包)</td>
			    			<td><input class="easyui-textbox" type="text" name="lac" data-options="required:true"></input></td>
			    			<td>cellid</td>
			    			<td><input class="easyui-textbox" type="text" name="cellid" data-options="required:true"></input></td>
			    			<td>signal</td>
			    			<td><input class="easyui-textbox" type="text" name="signal" data-options="required:true"></input></td>
			    		</tr>
...
// 			$('#ff').form('submit');
			$.ajax({
                cache: true,
                type: "POST",
                url:"${pageContext.request.contextPath}/plData",
