...
<body>  
	...
	<div style="margin:20px 0;" align="left">
		<div class="easyui-panel" title="PH" style="width:800px">
			    ...
			    <form id="ff" method="post" action="">
			    	<table cellpadding="5">
			    		...
			    		<tr>
			    			...
			    			<td>imsi</td>
			    			<td><input class="easyui-textbox" type="text" name="imsi" data-options="required:true"></input></td>
			    		</tr>
			    		
			    		<tr>
			    			<td>powerVoltage</td>
			    			<td><input class="easyui-textbox" type="text" name="powerVoltage" data-options="required:true"></input></td>
			    			<td>batteryVotage</td>
			    			<td><input class="easyui-textbox" type="text" name="batteryVotage" data-options="required:true"></input></td>
			    			<td>sensity</td>
			    			<td><input class="easyui-textbox" type="text" name="sensity" data-options="required:true"></input></td>
			    		</tr>
			    		<tr>
			    			<td>star</td>
			    			<td><input class="easyui-textbox" type="text" name="star" data-options="required:true"></td>
			    			<td>ecode</td>
			    			<td><input class="easyui-textbox" type="text" name="ecode" data-options="required:true"></td>
			    		</tr>
			    	</table>
			    </form>
